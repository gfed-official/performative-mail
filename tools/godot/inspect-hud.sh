...
expect "QuotaLabel=Quota 640 / 2214"
expect "SurplusLabel="
expect "ComplaintLabel=23"
expect "HeldAddress=13 Larch Lane"
expect "TargetAddress=13 Larch Lane"
expect "MatchMark=tick"
expect "CompassFacing=N"
expect "CompassDistrict=1"
expect "CompassSlots=000000000011111110000000"
expect "HpLabel=HP 100"
expect "WeightLabel=Wt 0"
expect "HotbarSelected=1"
expect "HotbarSlot0 icon=hands count= address= selected=0"
expect "HotbarSlot1 icon=letter count=1 address=1/1/13 selected=1 district=1"
expect "HotbarSlot2 icon=empty count= address= selected=0"
expect "HotbarSlot7 icon=empty count= address= selected=0"
