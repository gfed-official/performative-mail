...
expect "hotbar[0,0] count= address= pending=0 opacity=1.0 icon=hands"
expect "hotbar[1,0] count=1 address=1/1/13 pending=1 opacity=0.6 icon=letter district=1 swatch=#3D7EFF"
expect "hotbar_1_0 text=1 1/1/13 opacity=0.6"
expect "hotbar_1_0_swatch color=#3D7EFF"
